<a href="#modal-color3" class="js-modal">Modifier la couleur des categories</a>
    
    <aside id="modal-color3" class="modal" aria-hidden="true" role="dialog" aria-labelledby="modal-title" style="display:none">
